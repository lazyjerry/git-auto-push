...
# 其他选项
./git-auto-push.sh --version   # 显示版本号
./git-auto-push.sh --auto      # 全自动模式
```
...
- 总版本数：16 个主要版本
- 开发期间：2025-08-21 至今
- 代码行数：`git-auto-push.sh` 2,552 行、`git-auto-pr.sh` 2,769 行、`install.sh` 773 行
